...
public class ButtonSelectPointDown2 : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        GameObject.Find("GameLogic").GetComponent<GameLogic>().BtnTamaSelect_2();
