...
public class ButtonSelectPointDown6 : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        GameObject.Find("GameLogic").GetComponent<GameLogic>().BtnTamaSelect_6();
