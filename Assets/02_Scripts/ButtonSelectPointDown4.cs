...
public class ButtonSelectPointDown4 : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        GameObject.Find("GameLogic").GetComponent<GameLogic>().BtnTamaSelect_4();
