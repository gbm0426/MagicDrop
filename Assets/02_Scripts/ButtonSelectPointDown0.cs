...
public class ButtonSelectPointDown0 : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        GameObject.Find("GameLogic").GetComponent<GameLogic>().BtnTamaSelect_0();
