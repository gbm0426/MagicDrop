...
public class ButtonSelectPointDown1 : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        GameObject.Find("GameLogic").GetComponent<GameLogic>().BtnTamaSelect_1();
